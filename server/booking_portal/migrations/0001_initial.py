    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_remarks', models.CharField(blank=True, max_length=250, null=True)),
                ('faculty_remarks', models.CharField(blank=True, max_length=250, null=True)),
                ('lab_assistant_remarks', models.CharField(blank=True, max_length=250, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='Emails', to='booking_portal.Request')),
            ],
            options={
                'verbose_name': 'Email',
